...
import { faMapPin, faShuttleVan, faBus } from "@fortawesome/free-solid-svg-icons";
...
class ManagePage extends Component {
    ...
    handleUpcommingTansUpdate = () => {
        fetchGet("/api/reservation/viewRecent", {}, this.reservationCallback);
    };
        ...
        return (
            <Container maxWidth="xl">
                ...
                <Grid container spacing={2} className="manager-grid">
                    ...
                    <Grid item xs={12} sm={12} md={12} lg={12} px={0}>
...
// The confirmation modal for modify and cancel actions
